...
/**
 * Customisations for the Category resource.
 *
 ...
 *
 * Rows are typed as Category, so row.id and friends autocomplete and a renamed
 ...
 */
const custom: ResourceCustomisation<Category> = {};

...
/**
 * Customisations for the OrderItem resource.
 *
 ...
 *
 * Rows are typed as OrderItem, so row.id and friends autocomplete and a renamed
 ...
 */
const custom: ResourceCustomisation<OrderItem> = {};

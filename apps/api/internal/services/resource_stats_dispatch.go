...
func ComputeResourceStats(db *gorm.DB, resourceName string, filter ResourceStatsFilter) (*ResourceStats, error) {
	...
	case "categories":
		return reflectiveResourceStats(db, resourceName, &models.Category{}, filter)

	case "products":
		return reflectiveResourceStats(db, resourceName, &models.Product{}, filter)

	case "order_items":
		return reflectiveResourceStats(db, resourceName, &models.OrderItem{}, filter)

	case "orders":
		return reflectiveResourceStats(db, resourceName, &models.Order{}, filter)
